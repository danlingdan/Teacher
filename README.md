...
SQLTeacher 是一款面向数据库课程教学与 SQL 练习的本地优先 Java 桌面应用。`v1.6.1` 修复网络 AI 根地址兼容和错误提示问题；v1.6 系列将本地 Ollama 与 OpenAI-compatible 网络模型收敛为可配置、可解释、可降级的统一 AI 教学工作区，并继续坚持 AI 只生成待审查草稿的安全边界。
