...
public final class LocalAppContract {
    ...
    public static final Set<String> API_METHODS = Set.of(
        ...
        "knowledge.bundle.check", "knowledge.bundle.download", "knowledge.bundle.remove",
        "knowledge.overview",
        ...
        "practice.wrongbook", "practice.paths",
        ...
        "data.connection.test", "data.connection.select", "data.connection.delete", "data.connection.databases", "data.schema",
        "data.table.sample",
        "sql.analyze", "sql.execute", "sql.result.page", "sql.history", "sql.history.clear",
        "sql.result.export", "ai.knowledge.ask", "ai.sql.preview", "ai.sql.generate", "ai.exercise.explain",
        ...
        "account.password.reset.request", "account.password.reset",
        ...
        "cloud.class.create", "cloud.class.member.add", "cloud.class.roster",
