...
public final class LocalAppContract {
    ...
    public static final Set<String> API_METHODS = Set.of(
        ...
        "teaching.exercise.import", "teaching.exercise.export", "teaching.analytics",
        ...
        "settings.workspace", "settings.update", "settings.component.install", "settings.component.cancel",
