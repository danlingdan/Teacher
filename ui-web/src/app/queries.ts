...
import type { CourseWorkspace, HealthResult, HomeSummary, SessionResult, SettingsPreferences } from "../shared/types";
...
export const settingsPreferencesQuery = queryOptions({ queryKey: ["settings", "preferences"], queryFn: () => localAppRequest<SettingsPreferences>("settings.preferences"), staleTime: 30_000 });
